...
public class Handlers {
  ...
  public Handlers(CqlSession session) {
    this.session = session;
  }

  public Context getUser(Context ctx) {
  ...
  public Context home(Context ctx) {
    String username = ctx.pathParam("username");
    SimpleStatement s =
  ...
  public Context follow(Context ctx) {
  ...
  public Context unfollow(Context ctx) {
    String follower = ctx.pathParam("username");
    String followee = ctx.pathParam("followee_username");
  ...
  public Context following(Context ctx) {
    String username = ctx.pathParam("username");
    SimpleStatement s =
        SimpleStatement.newInstance(
  ...
  public Context followedBy(Context ctx) {
    String username = ctx.pathParam("username");
    SimpleStatement s =
        SimpleStatement.newInstance(
  ...
  public Context getAllStatuses(Context ctx) {
    String username = ctx.pathParam("username");
    SimpleStatement s =
        SimpleStatement.newInstance(
    ...
    ResultSet rs = session.execute(s);
    List<Row> rows = rs.all();
    return ctx.json(rows.stream().map(this::rowToStatus).collect(Collectors.toList()));
  }

  public Context getStatus(Context ctx) {
    String username = ctx.pathParam("username");
  ...
  public Context createStatus(Context ctx) {
    String username = ctx.pathParam("username");
  ...
  public Context deleteStatus(Context ctx) {
    String username = ctx.pathParam("username");
    String statusId = ctx.pathParam("status_id");
    SimpleStatement getFollowers =
        SimpleStatement.newInstance(
  ...
  private Status rowToStatus(Row row) {
